export function Last() {
    return (
        <div className="w-full h-screen text-white">
            ...
            <div className="grid grid-cols-2 leading-5 sm:grid-cols-4">
                
                <div className="col-span-1 flex flex-col gap-1 bg-amber-400 text-white p-3">
                ...
                <div className="col-span-1 flex flex-col gap-1 bg-orange-500 p-3">
                ...
                <div className="col-span-1 flex flex-col gap-1 bg-orange-600 p-3">
                <p className="font-semibold text-xl">Services</p>
                <p>Express Parcel</p>
                <p>Warehousing</p>
                <p>Part Truckload</p>
            ...
            <div className="flex w-screen bg-black text-gray-500 justify-around text-xs">
